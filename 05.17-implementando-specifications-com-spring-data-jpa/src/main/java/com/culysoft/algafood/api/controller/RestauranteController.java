...
import com.culysoft.algafood.infrastructure.repository.spec.RestauranteComNomesSemelhantesSpec;
import com.culysoft.algafood.infrastructure.repository.spec.RestaurantesComTaxaFreteGratisSpec;
...
public class RestauranteController {
    ...
    public List<Restaurante> buscarPorTaxaFreteGratis(String nome) {
        var taxaFreteGratis = new RestaurantesComTaxaFreteGratisSpec();
        var taxaFreteComNomesSemelhantes = new RestauranteComNomesSemelhantesSpec(nome);

        return restauranteRepository.findAll(taxaFreteGratis.and(taxaFreteComNomesSemelhantes));
    }
